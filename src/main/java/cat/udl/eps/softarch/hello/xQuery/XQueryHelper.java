...
public class XQueryHelper {
    ...
    public static final String[] teamsName = {"FC Barcelona", "Real Madrid", "Atlético Madrid", "Sevilla FC", "Valencia CF","Athletic Club", "Real Sociedad","Malaga CF","Cordoba CF","Levante UD","RC Celta de Vigo", "RC Deportivo de la Coruña","SD EIbar","Rayo Vallecano","Getafe CF","RCD Espanyol", "Granada CF","Elche CF","UD Almeria","Villareal CF" };
